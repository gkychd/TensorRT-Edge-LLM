 ...
 */
void gemv_bf16_forward_cuda_new(__nv_bfloat16 const* in_feats, int8_t const* kernel, __nv_bfloat16 const* scaling_factors, __nv_bfloat16* out_feats,
 ...
 * @param stream CUDA stream
 */
void gemm_bf16_forward_cuda_new(__nv_bfloat16 const* in_feats, int8_t const* kernel, __nv_bfloat16 const* scaling_factors, __nv_bfloat16* out_feats,
