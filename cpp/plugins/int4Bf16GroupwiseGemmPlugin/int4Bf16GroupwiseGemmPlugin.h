 ...
 */
class Int4Bf16GroupwiseGemmPlugin : public nvinfer1::IPluginV3,
...
public:
     ...
     */
    Int4Bf16GroupwiseGemmPlugin(std::string const& name, int32_t N, int32_t K, int32_t groupSize);
     ...
     */
    Int4Bf16GroupwiseGemmPlugin(std::string const& name, nvinfer1::PluginFieldCollection const* fc);

    //! @brief Deleted default constructor
    Int4Bf16GroupwiseGemmPlugin() = delete;

    //! @brief Deleted copy constructor
    Int4Bf16GroupwiseGemmPlugin(Int4Bf16GroupwiseGemmPlugin const&) = delete;

    //! @brief Destructor
    ~Int4Bf16GroupwiseGemmPlugin() override;
...
/*!
 * @brief Factory for creating Int4Bf16GroupwiseGemmPlugin instances
 *
 * Handles plugin registration and creation in TensorRT.
 */
class Int4Bf16GroupwiseGemmPluginCreator : public nvinfer1::IPluginCreatorV3One
{
public:
    //! @brief Constructor
    Int4Bf16GroupwiseGemmPluginCreator();

    //! @brief Destructor
    ~Int4Bf16GroupwiseGemmPluginCreator() override = default;
